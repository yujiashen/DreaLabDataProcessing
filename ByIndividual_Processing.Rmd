...
```{r load-rename-data}
i <- read_excel("data/Pup8MoIndividual_copy_for_ys.xlsx", sheet = 2)
...
```{r Dig}
#For digs which are followed by behavior != Nearest neigh, Other vig, or Ends --> 
#mark and put ending sec as starting second of following behavior
#Then, join these back into dataframe
dataFirstJoin <- data %>%
...
```{r}
write.xlsx(data, "data_file2.xlsx")
```
